...
#  user_data                   = templatefile("${path.module}/configs/${var.name}.tpl", { vm_name = var.name })
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo wget -O requirements.txt https://raw.githubusercontent.com/conradcorbett/ec2flask/master/module-ec2/configs/flask/requirements.txt",
      "sudo mkdir templates",
      "sudo wget -O templates/index.html https://raw.githubusercontent.com/conradcorbett/ec2flask/master/module-ec2/configs/flask/templates/index.html",
      "sudo wget -O templates/users.html https://raw.githubusercontent.com/conradcorbett/ec2flask/master/module-ec2/configs/flask/templates/users.html",
      "sudo ./flask.sh",
      "sudo chmod 777 db.yaml",
      "sudo echo mysql_password: ${var.db_pwd} >> /home/ec2-user/db.yaml",
      "sudo wget -O role-id https://raw.githubusercontent.com/conradcorbett/ec2flask/master/module-ec2/configs/flask/role-id",
      "sudo wget -O secret-id https://raw.githubusercontent.com/conradcorbett/ec2flask/master/module-ec2/configs/flask/secret-id",
      "sudo wget -O source.tpl https://raw.githubusercontent.com/conradcorbett/ec2flask/master/module-ec2/configs/flask/source.tpl",
      "sudo wget -O config.hcl https://raw.githubusercontent.com/conradcorbett/ec2flask/master/module-ec2/configs/flask/config.hcl",
